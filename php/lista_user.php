<?php 
    ...
    if(isset($busqueda) && $busqueda != ""){
        ...
        $consulta_total = "SELECT COUNT(usuario_id) FROM usuarios WHERE ((id_usuario != $id_user) AND (nombre_usuario LIKE %$busqueda% OR apellido_nombre LIKE %$busqueda% OR %$busqueda% )); ";
    }else{
    ...
    $total = (int) mysqli_fetch_array($total);
